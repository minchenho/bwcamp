...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
    ...
    <tr><td>
        ...
        @elseif($applicant->batch->name == "北區")
            親愛的企業主管您好 : <br><br>
            &emsp;&emsp;歡迎您參加「{{ $applicant->batch->camp->fullName }}」，期待您的蒞臨，並能有豐盛的收穫！<br>
            &emsp;&emsp;為使三天的營隊能順利進行，請詳閱以下的「注意事項」。<br>
            &emsp;&emsp;並請於報到時，攜帶電子郵件附件內的QR&nbsp;Code辦理報到手續。<br><br>
            <ul>
                ...
                <li>報到時間：{{ $applicant->batch->batch_start }}&nbsp;({{ $applicant->batch->batch_start_weekday }})&nbsp;<a style="color: red;">上午09:00~10:30。</a><br>
                </li>
                <li>報到地點：{{ $applicant->batch->locationName }}&nbsp;愛園大樓前({{ $applicant->batch->location }})<br>
                </li>
                <li>交通資訊：<br>
                    <u>接駁服務：</u><br>
                    報到當天{{ $applicant->batch->batch_start }}，基金會在以下地點，提供交通接駁服務；現場將有穿著黃色背心的義工協助引導。<br>
                    (1)&nbsp;外縣市學員/電訪回覆台北車站接駁:<br>
                    <a style="color: red;">09:10~09:40&nbsp;於<u>台鐵台北車站一樓&nbsp;南一門</u></a><br>
                    (逾09:40，請自行搭乘計程車前往。)<br>
                    (2)&nbsp;台北市/新北市學員或電訪回覆一般捷運接駁:<br>
                    <a style="color: red;">09:10~10:15&nbsp;於<u>台北捷運淡水信義線(紅線)&nbsp;復興崗站1號出口</u></a><br>
                ...
                <ol>
                    ...
                    <li>{{ $applicant->batch->batch_end }}課程預定於16:50結束，如需訂購回程車票，請考慮18:30以後之班次。</li>
                </ol>
                </li>
            </ul>
            <br><br>
            若有任何問題，歡迎與關懷員們聯絡，或來電本會&nbsp;(02)7751-6799&nbsp;分機&nbsp;611203&nbsp;企業營報名報到組。
        @endif
